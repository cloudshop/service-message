package com.eyun.message;

import com.eyun.message.client.OAuth2InterceptedFeignConfiguration;
import com.eyun.message.config.ApplicationProperties;
import com.eyun.message.config.DefaultProfileUtil;
